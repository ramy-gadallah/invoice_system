        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('update.invoice',$invoices->id)}}" method="POST" autocomplete="off">
                        @csrf
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <option value={{ $invoices->section->id }} >{{ $section->section_name }}</option>
                                    @endforeach 
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <option value={{ $product->id }} @if ($invoices->products->id == $product->id)   selected      @endif >
